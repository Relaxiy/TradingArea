...
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_CREATED_AT
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_DESCRIPTION
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_EMAIL
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_ID
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_IMAGES
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_PHONE_NUMBER
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_PRICE
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_TITLE
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_USERNAME
import com.example.cars.app.data.firebase.FirebasePostsDatabaseManagerImpl.Companion.KEY_USER_ID
